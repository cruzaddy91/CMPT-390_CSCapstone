...
export const CHART_PALETTE_FALLBACK = {
  ...
  totPoint: '#ffd489',
  quarterBorder: 'rgba(95, 228, 255, 0.95)',
  quarterFill: 'rgba(95, 228, 255, 0.18)',
  quarterPoint: '#a5ecff',
...
const KEYS = [
  ...
  ['quarterBorder', '--chart-quarter-border'],
  ['quarterFill', '--chart-quarter-fill'],
  ['quarterPoint', '--chart-quarter-point'],
